<script>
  ...
  function buildTimeline() {
    ...
    tl.set('.kamusai-segment2', { display: 'flex', autoAlpha: 1 }, 0);
...
<div class="kamusai-page"><div class="kamusai-wrap" bind:this={wrapEl}><div class="kamusai-stage" bind:this={canvasEl}>
  <div class="kamusai-sec kamusai-segment2"><h1 class="seg-title">SEGMENT 2</h1></div>
</div></div></div>
...
.seg-title{font-size:140px;font-weight:900;color:#7AE582;text-shadow:0 0 60px rgba(122,229,130,0.8)}
</style>
